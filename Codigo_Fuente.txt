// --- Bibliotecas ---
#include <ESP32Servo.h> // Necesaria para el control angular preciso del ervomotor
...
int anguloDispensa = 140; // POSICIÓN 1: Ángulo al que se mueve para que AIGA el alimento
...
dispensador.attach(pinServo); // Asocia el objeto 'dispensador' al pin 13
...
// Reinicia la bandera a FALSE: El comedero está listo para la próxima ez
dispensado = false;
